        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                @can('permission-create')
                    <a href="{{ route('setting.permission.create') }}" class="btn btn-success d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New
                    </a>
                @endcan
            </div>
        </div>
                ...
                @foreach ($permissions as $key => $permission)
                    <tr>
                        ...
                        <td class="text-center">
                            @can('permission-edit')
                                <a class="btn btn-primary" href="{{ route('setting.permission.edit', $permission->id) }}"><i class="fa fa-edit"></i></a>
                            @endcan
