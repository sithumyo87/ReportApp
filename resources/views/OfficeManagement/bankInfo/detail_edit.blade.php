...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">{{ $bankInfo->name }} Detail Edit</h4>
        </div>
    ...
    <div class="bg-white p-30">
        ...
        {!! Form::model($bankInfoDetails, ['route' => ['OfficeManagement.bankInfoDetail.update', $bankInfoDetails->id], 'method' => 'PATCH']) !!}
