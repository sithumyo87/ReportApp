...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Customer Edit</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    @can('user-index')
                        <li class="breadcrumb-item"><a href="{{ route('OfficeManagement.customer.index') }}">Customer</a></li>
                    @endcan
    ...
    <div class="bg-white p-30 ">
        ...
        {!! Form::model($customer, ['method' => 'PATCH', 'route' => ['OfficeManagement.customer.update', $customer->id]]) !!}
        <div class="row justify-content-center mt-3">
            <div class="col-xs-12 col-sm-12 col-md-8">
                ...
                <div class="text-center">
                    <a href="{{ route('OfficeManagement.customer.index') }}" class="btn btn-warning">{{ __('button.cancel') }}</a>
