        ...
        <div class="row justify-content-center">
            <div class="col-xs-12 col-sm-12 col-md-8 mt-3">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('label_name', null, ['placeholder' => 'Form 31 number', 'class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    <label for="">Invoice Number</label>
                    {!! Form::text('value_name', null, ['placeholder' => 'Invoice Number', 'class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    <label for="">Description</label>
                    {!! Form::textarea('value_name', null, ['placeholder' => 'value', 'class' => 'form-control tinymce-editor', 'rows' => '5']) !!}
                </div>
                <div class="form-group">
